...
import 'package:trial/View/Resturant/ResturantList.dart';
import 'package:trial/View/Home/Home.dart';
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("Bangalore, India",style: TextStyle(fontSize: titleText,color: secondryColor),),
                  SizedBox(height: 5.0,),
  ...
  Widget drawerMenu(){
    return Column(
      children: <Widget>[
        ...
        drawerList(active: false,icon: Icons.bookmark_border,name:"Orders",id: "MY_ORDER"),
