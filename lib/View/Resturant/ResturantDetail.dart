...
import 'package:trial/View/Resturant/MenuView.dart';
import 'package:trial/View/Resturant/PlaceDetailsView.dart';
import 'package:trial/View/Resturant/PlaceReviewView.dart';
        ...
        Container(
          child: TabBar(
            ...
            tabs: <Widget>[
              ...
              Tab(
                child: Text(toUpper("Food Item detail"),style: detailsTabTitle(),),
              ),
              Tab(
                child: Text(toUpper("Food Item review"),style: detailsTabTitle(),),
              )
            ],
          ),
          color: Colors.white,
